...
class TabBuka(ctk.CTkFrame):
    ...
    def _build_card_file(self):
        card = make_card(self)
        ctk.CTkLabel(card, text="📄  FILE BRANKAS (.locked)", font=FONT_LABEL,
    ...
    def _clear_file(self):
        ...
        self.lbl_path.configure(text="File belum dipilih", text_color=CLR_MUTED)
